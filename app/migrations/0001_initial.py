# Generated by Django 5.1.5 on 2025-07-14 10:55

import app.models.Document_model
import app.models.Expense_model
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='officialDocs/', validators=[app.models.Document_model.validate_file_extension])),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_type', models.CharField(choices=[('travel', 'Travel'), ('office_supplies', 'Office Supplies'), ('entertainment', 'Client Entertainment'), ('training', 'Training'), ('other', 'Other')], max_length=50)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('receipt', models.FileField(upload_to='receipts/', validators=[app.models.Expense_model.validate_file_extension])),
